...
},{"core-js/fn/regexp/escape":3,"core-js/shim":325,"regenerator-runtime/runtime":327}],2:[function(require,module,exports){
/*!
...
$(function () {
  ...
  // Preload
  $('.curtain').css('width', 0).find('.sk-double-bounce').css('opacity', 0); // end preload

  // For scroll
  $(window).on('click', '#connectMe', function () {
    var scrollTo = $($(this).data('href')).offset().top;
...
},{"./../blocks/custom/custom.js":328,"./../blocks/index.js":329,"babel-polyfill":1,"bootstrap-sass":2,"jquery":326}]},{},[330])
